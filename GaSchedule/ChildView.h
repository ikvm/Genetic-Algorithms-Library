...
#include "../GeneticLibrary/source/Chromosome.h"
#include "../GeneticLibrary/source/AlgorithmState.h"
...
public:
	...
	void SetNewState(GaAlgorithmState state);
